    ...
    def cu(self, line, cell):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with open(file_path + ext, "w") as f:
                f.write(cell)
            try:
                compiler_cmd = compiler_flags + [file_path + ext, "-o", file_path + ".out"]
                print("compiler cmd:", " ".join(compiler_cmd))
                subprocess.check_output(compiler_cmd, stderr=subprocess.STDOUT)
